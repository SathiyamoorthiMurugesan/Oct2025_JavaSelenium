...
import d3ForEachLoop.A2ForEachCommonMethods;
...
//		boolean checkTwoArraysAreEqual = Arrays.equals(ar1, ar2);
		...
		obj.printArrayUsingForEach(copiedArray);
		
		
		System.out.println("********copyOfRange*************");
		int[] copiedArrayWithRange = Arrays.copyOfRange(ar1, 1, 4);
		obj.printArrayUsingForEach(copiedArrayWithRange);
		
		
		System.out.println("********fill*************");
		Arrays.fill(ar1, 100);
		obj.printArrayUsingForEach(ar1);
